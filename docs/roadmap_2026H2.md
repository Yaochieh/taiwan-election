...
## 附：旗艦承諾職位歸位稽核（2026-07-05 收尾）

- 陳其邁 2018 落選政見（社區關懷據點倍增、道路修補 8 小時）撤旗艦、標
  `not_executed`——落選政見無執行機會，不列兌現追蹤。替補為 2022 政見
  「一國中學區一日照中心」（91 學區，衛生局 2025-09：76 學區/145 家，
  note 揭露屬中央長照 2.0 目標、跨任期累計）。
- 黃偉哲 2018 兩條幼教承諾結案 `achieved`，但 note/verification 均揭露
  **結果由中央「我國少子女化對策計畫」（108 年 8 月起）實現**，非市府
  自辦；來源為臺南市教育局補助簡表（L1）。
- `_DOMAIN_AUTH` 新增 `tn.edu.tw`（臺南市教育局，L1）。
- 至此 15 條旗艦全數有進度紀錄與來源，零留白。
